...
import net.mcreator.cumzone.block.HerpesWoodPlanksBlock;
import net.mcreator.cumzone.block.AidsWoodPlanksBlock;
import net.mcreator.cumzone.CumzoneModElements;

@CumzoneModElements.ModElement.Tag
public class GARBAGEDUMPBiome extends CumzoneModElements.ModElement {
	public static Biome biome;

	public GARBAGEDUMPBiome(CumzoneModElements instance) {
		super(instance, 206);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(AidsWoodPlanksBlock.block.getDefaultState(),
								HerpesWoodPlanksBlock.block.getDefaultState(), HerpesWoodPlanksBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("cumzone:garbagedump"));
			}
		}
	}
