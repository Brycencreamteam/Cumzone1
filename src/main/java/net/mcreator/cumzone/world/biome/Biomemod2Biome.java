...
import net.mcreator.cumzone.block.Fluidcumzone1Block;
import net.mcreator.cumzone.CumzoneModElements;

@CumzoneModElements.ModElement.Tag
public class Biomemod2Biome extends CumzoneModElements.ModElement {
	public static Biome biome;

	public Biomemod2Biome(CumzoneModElements instance) {
		super(instance, 8);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Fluidcumzone1Block.block.getDefaultState(),
								Fluidcumzone1Block.block.getDefaultState(), Fluidcumzone1Block.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("cumzone:biomemod_2"));
			}
		}
	}
