...
public class CockwoodFenceBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:cockwood_fence")
	public static final Block block = null;

	public CockwoodFenceBlock(CumzoneModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("cockwood_fence");
		}
