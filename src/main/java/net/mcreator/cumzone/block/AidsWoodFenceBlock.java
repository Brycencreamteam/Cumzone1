...
public class AidsWoodFenceBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_fence")
	public static final Block block = null;

	public AidsWoodFenceBlock(CumzoneModElements instance) {
		super(instance, 172);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("aids_wood_fence");
		}
