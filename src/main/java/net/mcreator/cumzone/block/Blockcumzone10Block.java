...
public class Blockcumzone10Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:blockcumzone_10")
	public static final Block block = null;

	public Blockcumzone10Block(CumzoneModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("blockcumzone_10");
		}
