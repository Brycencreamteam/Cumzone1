...
public class CockwoodSlabBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:cockwood_slab")
	public static final Block block = null;

	public CockwoodSlabBlock(CumzoneModElements instance) {
		super(instance, 49);
	}
