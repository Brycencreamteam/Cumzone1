...
public class CockwoodFenceGateBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:cockwood_fence_gate")
	public static final Block block = null;

	public CockwoodFenceGateBlock(CumzoneModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("cockwood_fence_gate");
		}
