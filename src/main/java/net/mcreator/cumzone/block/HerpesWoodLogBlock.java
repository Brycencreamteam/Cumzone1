...
public class HerpesWoodLogBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_log")
	public static final Block block = null;

	public HerpesWoodLogBlock(CumzoneModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_log");
		}
