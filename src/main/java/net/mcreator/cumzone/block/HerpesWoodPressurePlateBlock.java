...
public class HerpesWoodPressurePlateBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_pressure_plate")
	public static final Block block = null;

	public HerpesWoodPressurePlateBlock(CumzoneModElements instance) {
		super(instance, 194);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_pressure_plate");
		}
