...
public class CockwoodWoodBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:cockwood_wood")
	public static final Block block = null;

	public CockwoodWoodBlock(CumzoneModElements instance) {
		super(instance, 44);
	}
