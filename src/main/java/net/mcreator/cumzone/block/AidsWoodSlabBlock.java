...
public class AidsWoodSlabBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_slab")
	public static final Block block = null;

	public AidsWoodSlabBlock(CumzoneModElements instance) {
		super(instance, 171);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("aids_wood_slab");
		}
