...
public class Blockcumzone7Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:blockcumzone_7")
	public static final Block block = null;

	public Blockcumzone7Block(CumzoneModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("blockcumzone_7");
		}
