...
public class CockwoodButtonBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:cockwood_button")
	public static final Block block = null;

	public CockwoodButtonBlock(CumzoneModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("cockwood_button");
		}
