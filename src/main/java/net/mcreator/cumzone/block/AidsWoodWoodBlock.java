...
public class AidsWoodWoodBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_wood")
	public static final Block block = null;

	public AidsWoodWoodBlock(CumzoneModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("aids_wood_wood");
		}
