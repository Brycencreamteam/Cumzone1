...
public class Block76Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_76")
	public static final Block block = null;

	public Block76Block(CumzoneModElements instance) {
		super(instance, 285);
	}
