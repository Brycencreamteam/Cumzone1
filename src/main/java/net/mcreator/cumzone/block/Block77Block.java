...
public class Block77Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_77")
	public static final Block block = null;

	public Block77Block(CumzoneModElements instance) {
		super(instance, 284);
	}
