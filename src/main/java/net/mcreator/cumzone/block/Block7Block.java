...
public class Block7Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_7")
	public static final Block block = null;

	public Block7Block(CumzoneModElements instance) {
		super(instance, 130);
	}
