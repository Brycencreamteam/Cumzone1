...
public class Blockcumzone5Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:blockcumzone_5")
	public static final Block block = null;

	public Blockcumzone5Block(CumzoneModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockcumzone_5");
		}
