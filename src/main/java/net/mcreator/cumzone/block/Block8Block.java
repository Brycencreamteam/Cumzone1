...
public class Block8Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_8")
	public static final Block block = null;

	public Block8Block(CumzoneModElements instance) {
		super(instance, 213);
	}
