...
public class AidsWoodPlanksBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_planks")
	public static final Block block = null;

	public AidsWoodPlanksBlock(CumzoneModElements instance) {
		super(instance, 168);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aids_wood_planks");
		}
