...
public class Block72Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_72")
	public static final Block block = null;

	public Block72Block(CumzoneModElements instance) {
		super(instance, 289);
	}
