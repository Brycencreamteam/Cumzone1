...
public class HerpesWoodFenceBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_fence")
	public static final Block block = null;

	public HerpesWoodFenceBlock(CumzoneModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_fence");
		}
