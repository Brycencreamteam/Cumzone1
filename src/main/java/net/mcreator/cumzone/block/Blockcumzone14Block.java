...
public class Blockcumzone14Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:blockcumzone_14")
	public static final Block block = null;

	public Blockcumzone14Block(CumzoneModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockcumzone_14");
		}
