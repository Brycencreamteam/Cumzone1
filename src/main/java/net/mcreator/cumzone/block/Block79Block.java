...
public class Block79Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_79")
	public static final Block block = null;

	public Block79Block(CumzoneModElements instance) {
		super(instance, 282);
	}
