...
public class HerpesWoodWoodBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_wood")
	public static final Block block = null;

	public HerpesWoodWoodBlock(CumzoneModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 2f).setLightLevel(s -> 10).harvestLevel(0)
					.harvestTool(ToolType.AXE).setRequiresTool().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("herpes_wood_wood");
		}
