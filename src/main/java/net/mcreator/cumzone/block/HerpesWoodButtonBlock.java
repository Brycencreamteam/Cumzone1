...
public class HerpesWoodButtonBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_button")
	public static final Block block = null;

	public HerpesWoodButtonBlock(CumzoneModElements instance) {
		super(instance, 195);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_button");
		}
