...
public class Block73Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_73")
	public static final Block block = null;

	public Block73Block(CumzoneModElements instance) {
		super(instance, 288);
	}
