...
public class CockwoodPressurePlateBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:cockwood_pressure_plate")
	public static final Block block = null;

	public CockwoodPressurePlateBlock(CumzoneModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("cockwood_pressure_plate");
		}
