...
public class Blockcumzone9Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:blockcumzone_9")
	public static final Block block = null;

	public Blockcumzone9Block(CumzoneModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockcumzone_9");
		}
