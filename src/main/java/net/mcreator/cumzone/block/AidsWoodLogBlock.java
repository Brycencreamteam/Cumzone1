...
public class AidsWoodLogBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_log")
	public static final Block block = null;

	public AidsWoodLogBlock(CumzoneModElements instance) {
		super(instance, 167);
	}
