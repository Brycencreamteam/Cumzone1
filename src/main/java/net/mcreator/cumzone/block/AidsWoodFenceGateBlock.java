...
public class AidsWoodFenceGateBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_fence_gate")
	public static final Block block = null;

	public AidsWoodFenceGateBlock(CumzoneModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("aids_wood_fence_gate");
		}
