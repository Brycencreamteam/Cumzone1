...
public class AidsWoodStairsBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_stairs")
	public static final Block block = null;

	public AidsWoodStairsBlock(CumzoneModElements instance) {
		super(instance, 170);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("aids_wood_stairs");
		}
