...
public class AidsWoodPressurePlateBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_pressure_plate")
	public static final Block block = null;

	public AidsWoodPressurePlateBlock(CumzoneModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("aids_wood_pressure_plate");
		}
