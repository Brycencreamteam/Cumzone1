...
public class Blockcumzone11Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:blockcumzone_11")
	public static final Block block = null;

	public Blockcumzone11Block(CumzoneModElements instance) {
		super(instance, 152);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockcumzone_11");
		}
