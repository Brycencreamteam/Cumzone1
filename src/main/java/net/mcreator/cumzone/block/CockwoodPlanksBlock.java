...
public class CockwoodPlanksBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:cockwood_planks")
	public static final Block block = null;

	public CockwoodPlanksBlock(CumzoneModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cockwood_planks");
		}
