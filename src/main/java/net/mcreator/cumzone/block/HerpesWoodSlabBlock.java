...
public class HerpesWoodSlabBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_slab")
	public static final Block block = null;

	public HerpesWoodSlabBlock(CumzoneModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_slab");
		}
