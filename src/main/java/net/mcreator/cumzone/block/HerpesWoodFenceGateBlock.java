...
public class HerpesWoodFenceGateBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_fence_gate")
	public static final Block block = null;

	public HerpesWoodFenceGateBlock(CumzoneModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_fence_gate");
		}
