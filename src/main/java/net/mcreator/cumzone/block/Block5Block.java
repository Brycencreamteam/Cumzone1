...
public class Block5Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:block_5")
	public static final Block block = null;

	public Block5Block(CumzoneModElements instance) {
		super(instance, 316);
	}
