...
public class Blockcumzone8Block extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:blockcumzone_8")
	public static final Block block = null;

	public Blockcumzone8Block(CumzoneModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockcumzone_8");
		}
