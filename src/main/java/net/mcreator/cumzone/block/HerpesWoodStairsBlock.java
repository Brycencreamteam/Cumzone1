...
public class HerpesWoodStairsBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_stairs")
	public static final Block block = null;

	public HerpesWoodStairsBlock(CumzoneModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_stairs");
		}
