...
public class HerpesWoodPlanksBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:herpes_wood_planks")
	public static final Block block = null;

	public HerpesWoodPlanksBlock(CumzoneModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("herpes_wood_planks");
		}
