...
public class AidsWoodButtonBlock extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:aids_wood_button")
	public static final Block block = null;

	public AidsWoodButtonBlock(CumzoneModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("aids_wood_button");
		}
