...
public class AltaniumIngotItem extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:altanium_ingot")
	public static final Item block = null;

	public AltaniumIngotItem(CumzoneModElements instance) {
		super(instance, 87);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("altanium_ingot");
		}
