...
public class WhipItem extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:whip")
	public static final Item block = null;

	public WhipItem(CumzoneModElements instance) {
		super(instance, 346);
	}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Item modifier", (double) 0.5, AttributeModifier.Operation.ADDITION));
