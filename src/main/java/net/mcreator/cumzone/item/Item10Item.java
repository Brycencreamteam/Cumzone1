...
public class Item10Item extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:item_10")
	public static final Item block = null;

	public Item10Item(CumzoneModElements instance) {
		super(instance, 244);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("100% Faggot Proof"));
		}
	}
}
