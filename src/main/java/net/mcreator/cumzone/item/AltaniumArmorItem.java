...
public class AltaniumArmorItem extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:altanium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("cumzone:altanium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("cumzone:altanium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("cumzone:altanium_armor_boots")
	public static final Item boots = null;

	public AltaniumArmorItem(CumzoneModElements instance) {
		super(instance, 105);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT).isImmuneToFire()) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "cumzone:textures/models/armor/altanium__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
				}.setRegistryName("altanium_armor_helmet"));
		elements.items
				...
				}.setRegistryName("altanium_armor_chestplate"));
		elements.items
				...
				}.setRegistryName("altanium_armor_leggings"));
		elements.items
				...
				}.setRegistryName("altanium_armor_boots"));
	}
