...
public class Item17Item extends CumzoneModElements.ModElement {
	@ObjectHolder("cumzone:item_17")
	public static final Item block = null;

	public Item17Item(CumzoneModElements instance) {
		super(instance, 272);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The Kryptonite of Twitter Users"));
		}
	}
}
