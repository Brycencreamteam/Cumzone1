...
@OnlyIn(Dist.CLIENT)
public class KiannaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KiannaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldick(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("cumzone:textures/kiab1.png");
					}
				};
			});
		}
	...
	public static class Modeldick extends EntityModel<Entity> {
		...
		public Modeldick() {
			...
			Head.setTextureOffset(32, 0).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.5F, false);
			Body = new ModelRenderer(this);
			Body.setRotationPoint(0.0F, 0.0F, 0.0F);
			Body.setTextureOffset(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.0F, false);
			Body.setTextureOffset(16, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.25F, false);
			Body.setTextureOffset(44, 32).addBox(-5.9F, 0.0F, -7.0F, 5.0F, 6.0F, 5.0F, 0.0F, false);
			Body.setTextureOffset(44, 32).addBox(1.1F, 0.0F, -7.0F, 5.0F, 6.0F, 5.0F, 0.0F, false);
			Body.setTextureOffset(0, 0).addBox(-4.0F, 3.0F, -8.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			Body.setTextureOffset(0, 2).addBox(3.0F, 3.0F, -8.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
