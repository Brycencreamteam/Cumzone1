...
import net.mcreator.cumzone.entity.Entity3Entity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class Entity3Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Entity3Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbigblackbbc(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("cumzone:textures/kyrasbchsk1.png");
					}
				};
			});
		}
	...
	public static class Modelbigblackbbc extends EntityModel<Entity> {
		...
		public Modelbigblackbbc() {
			...
			RightLeg.setTextureOffset(20, 69).addBox(-4.2F, -2.0F, 2.0F, 5.0F, 6.0F, 5.0F, 0.0F, false);
			...
			LeftLeg.setTextureOffset(0, 69).addBox(-1.0F, -2.0F, 2.0F, 5.0F, 6.0F, 5.0F, 0.0F, false);
		}
